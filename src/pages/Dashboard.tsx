    ...
    <div className="space-y-4">
      ...
      <div className="bg-surface border border-border rounded-2xl p-5">
        ...
        <p className={`text-3xl font-extrabold ${balance >= 0 ? 'text-text' : 'text-danger'}`}>
          {loading || error ? '···' : formatMoney(balance)}
        </p>
      </div>
